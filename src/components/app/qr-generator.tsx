    ...
    <Card>
      ...
      <CardContent>
        <div className="grid gap-6 lg:grid-cols-[320px_1fr]">
          <div className="grid place-items-center rounded-lg border border-slate-200 bg-white p-6 dark:border-slate-800 dark:bg-slate-900">
            {result?.payload ? (
              <QRCodeSVG value={result.payload} size={248} level="H" includeMargin />
            ) : (
              <div className="grid size-[248px] place-items-center rounded-md bg-slate-100 text-sm text-slate-500 dark:bg-slate-800">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800 dark:border-blue-900 dark:bg-blue-950 dark:text-blue-100">
              <div className="flex gap-2">
                ...
                <p>
                  QR is regenerated on a 30-second cycle and verified on the server before attendance
                  is recorded.
                </p>
              </div>
            </div>
